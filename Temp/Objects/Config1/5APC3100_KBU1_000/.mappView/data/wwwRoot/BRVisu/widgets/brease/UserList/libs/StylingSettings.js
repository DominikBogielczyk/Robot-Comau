define([
    ...
    'use strict';
    /** 
     * @class widgets.brease.UserList.libs.StylingSettings
     ...
     * a second dropdown where the user can select which audit type this style should be applied to. 
     * 
    ...
    p._createRow = function (clickedRow) {
        ...
        row.push(this._getLabel('style_label_state_' + randomNumber, this.texts.state, this.config.children.left.label_state, currTop, 200));
        
        // row.push(this._getDropDown('style_dropdown_state_' + randomNumber, audits, this.config.children.left.dd_state, currSubTop, 300, 'left', obj.statePos));
