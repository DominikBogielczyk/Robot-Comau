define([
    ...
    'widgets/visionCockpit/DropDownBox/libs/FocusHandler',
    'widgets/visionCockpit/DropDownBox/libs/config/Config',
    'widgets/visionCockpit/DropDownBox/libs/config/InitState',
    'widgets/visionCockpit/DropDownBox/libs/SubmitQueue',
    'brease/decorators/LanguageDependency',
    'brease/decorators/VisibilityDependency',
    'widgets/visionCockpit/DropDownBox/libs/view/DropDownBoxView/DropDownBoxView',
    'widgets/visionCockpit/DropDownBox/libs/reducer/DropDownBoxActions',
    'widgets/visionCockpit/DropDownBox/libs/reducer/DropDownBoxReducer',
    ...
    /**
     * @class widgets.visionCockpit.DropDownBox
     *
    ...
    /**
     * @method getArrowHorizontalPosition 
     * Returns arrowHorizontalPosition.
     * @return {Integer}
     */
    p.getArrowHorizontalPosition = function () {
        return this.settings.arrowHorizontalPosition;
    };

    /**
     * @method setArrowHorizontalPosition
     * @param {Integer} value
     */
    p.setArrowHorizontalPosition = function (value) {
        this.settings.arrowHorizontalPosition = value;
    };
