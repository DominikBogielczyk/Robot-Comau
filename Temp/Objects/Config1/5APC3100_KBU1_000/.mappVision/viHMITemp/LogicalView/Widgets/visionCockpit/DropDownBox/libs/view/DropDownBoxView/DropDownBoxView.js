define([
    ...
    /**
    * @class widgets.visionCockpit.DropDownBox.libs.view.DropDownBoxView 
    */
    'use strict';
    ...
    p.render = function render() {
        ...
        this.el.addClass('visionCockpitDownBox DropDownBoxView');
    ...
    function _layoutArrowList(listPosition, ItemSize, listWidth, scaleFactor) {
        switch (listPosition) {
            case Enum.Position.bottom:
                ...
                this.arrow.css({ 
                    'margin-left': this.widget.settings.arrowHorizontalPosition,
