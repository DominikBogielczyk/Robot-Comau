 ...
 *  3. resizing
 *  4. rotation
 *  5. handles for resizing and rotation
 *  6. subclasses: DragHandler.jss
 */
/*global define*/
define(['libs/d3/d3', '../Common/DragHandler', '../Utils/Utils'], function (d3, DragHandler, Utilities) {
    'use strict';

    function RectangleRoi(className,
        smartControl,
        selectionController,
        roiSize,
        imageSize,
    ...
    RectangleRoi.prototype.prepareInternalSettings = function () {
    ...
    RectangleRoi.prototype.initialDraw = function () {
        var that = this,
        ...
        this.drawing.anchor.append('rect')
            ...
            .attr('stroke-width', this.defaultSettings.drawing.strokeWidth)
        ...
        this.drawing.anchor.select("rect.outline.moveHandle").style("stroke-width", this.defaultSettings.drawing.strokeWidth);
    ...
    RectangleRoi.prototype.dispose = function () {
        this.drawing.anchor.remove();
        this.callbackFn = [];
    };

    RectangleRoi.prototype.show = function () {
        this.drawing.anchor.style('visibility', 'visible');
    };

    RectangleRoi.prototype.hide = function () {
        this.drawing.anchor.style('visibility', 'hidden');
    };

    RectangleRoi.prototype.onMouseOver = function () {
    };

    RectangleRoi.prototype.onMouseOut = function () {
    };

    RectangleRoi.prototype.isSelected = function () {
        return this.selected;
    };

    RectangleRoi.prototype.clearSelection = function () {
        this.selectionController.setFirstSelectedRoiTool(this, false);
        this.selected = false;
    };

    RectangleRoi.prototype.setSelected = function (selected) {
    ...
    RectangleRoi.prototype.setSize = function (width, height) {
    ...
    RectangleRoi.prototype.moveToFront = function () {
    ...
    RectangleRoi.prototype.moveToBottom = function () {
    ...
    RectangleRoi.prototype.registerCallback = function (functionName, callBackFn) {
    ...
    RectangleRoi.prototype.onClickSurface = function () {
    ...
    RectangleRoi.prototype.onClickElement = function () {
        if (d3.event.defaultPrevented) {
            return;
        }
        this.setSelected(true);
    ...
    RectangleRoi.prototype.onMouseDown = function () {
    ...
    RectangleRoi.prototype.getCenterPosition = function () {
    ...
    RectangleRoi.prototype.getAbsolutePosition = function () {
        var x = parseFloat(d3.transform(this.drawing.anchor.attr("transform")).translate[0]),
            y = parseFloat(d3.transform(this.drawing.anchor.attr("transform")).translate[1]),
    ...
    RectangleRoi.prototype.getPixels = function () {
        var px = [],
            py = [],
            paintedPixels;
    ...
    RectangleRoi.prototype.appendPixelData = function (px, py) {
        var x, y,
    ...
    RectangleRoi.prototype.getXldPolygon = function () {
        ...
        for (var i = 0; i < polygon.length; i++) {
            xldPolygon.x.push(polygon[i].x);
            xldPolygon.y.push(polygon[i].y);
        }
        return xldPolygon;
    };

    RectangleRoi.prototype.updateColors = function () {
    ...
    RectangleRoi.prototype.handleDragstarted = function () {
        if (!this.isSelected()) {
            this.setSelected(true);
        }
    };

    RectangleRoi.prototype.handleDragend = function () {
        if (!this.isSelected()) {
            this.setSelected(true);
        }
        this.redrawDragend();
    ...
    RectangleRoi.prototype.showHandles = function () {
        this.drawing.anchor.selectAll("rect.outline.sizeHandle").style('visibility', "inherit");
        this.drawing.anchor.selectAll("circle.outline.turnHandle").style('visibility', "inherit");
        this.drawing.anchor.selectAll("line.outline.turnHandle").style('visibility', "inherit");
    };

    RectangleRoi.prototype.hideHandles = function () {
    ...
    RectangleRoi.prototype.hideHorizontalMidHandles = function () {
    ...
    RectangleRoi.prototype.hideVerticalMidHandles = function () {
    ...
    RectangleRoi.prototype.redrawDragend = function () {
        this.settings.resize_x0 = d3.transform(this.drawing.anchor.attr("transform")).translate[0];
        this.settings.resize_y0 = d3.transform(this.drawing.anchor.attr("transform")).translate[1];
    ...
    RectangleRoi.prototype.getBoundingRect = function () {
    ...
    RectangleRoi.prototype.getPolygon = function () {
        var x = parseFloat(d3.transform(this.drawing.anchor.attr("transform")).translate[0]),
            y = parseFloat(d3.transform(this.drawing.anchor.attr("transform")).translate[1]),
            width = parseFloat(this.drawing.anchor.select("rect.outline.moveHandle").attr("width")),
            height = parseFloat(this.drawing.anchor.select("rect.outline.moveHandle").attr("height")),
    ...
    RectangleRoi.prototype.getRoiParams = function () {
        var x = parseFloat(d3.transform(this.drawing.anchor.attr("transform")).translate[0]),
            y = parseFloat(d3.transform(this.drawing.anchor.attr("transform")).translate[1]),
            width = parseFloat(this.drawing.anchor.select("rect.outline.moveHandle").attr("width")),
            height = parseFloat(this.drawing.anchor.select("rect.outline.moveHandle").attr("height")),
    ...
    RectangleRoi.prototype.onUpdateZoomValue = function () {
        ...
        this.drawing.anchor.selectAll("rect.outline.moveHandle").style('stroke-width', this.defaultSettings.drawing.strokeWidth);
    ...
    RectangleRoi.prototype.updateRoi = function () {
    ...
    RectangleRoi.prototype.redraw = function () {
        var viewBox = this.smartControl.getViewBox(),
            zoom = {
                width: parseFloat(viewBox[2]),
                height: parseFloat(viewBox[3])
    ...
    RectangleRoi.prototype.rotateCounterclockwise = function (rotationAngle) {
        var that = this,
    ...
    RectangleRoi.prototype.setAngle = function (angle) {
        var that = this,
            xp = d3.transform(that.drawing.anchor.attr("transform")).translate[0],
            yp = d3.transform(that.drawing.anchor.attr("transform")).translate[1];
    ...
    RectangleRoi.prototype.showOrientationArrow = function (status) {
        var that = this;
    ...
    RectangleRoi.prototype.setCenterPosition = function () {
        var that = this;
    ...
    RectangleRoi.prototype.setWidthSameAsHeight = function () {
    ...
    RectangleRoi.prototype.setHeightSameAsWidth = function () {
    ...
    RectangleRoi.prototype.moveToPosition = function (x, y, angle) {
        this.drawing.anchor.attr('transform', "translate(" + x + ", " + y + ")rotate(" + angle + ")");
    };

    RectangleRoi.prototype.moveRelativePosition = function (deltaX, deltaY) {
        var x, y, angle;
    ...
    RectangleRoi.prototype.onMouseMoved = function (x, y) {
        this.selectionController.onMouseMoved(x, y);
    };

    RectangleRoi.prototype.onHandleDragend = function () {
        this.selectionController.onHandleDragend();
    };

    RectangleRoi.prototype.setAlignment = function (refRoiToolAngle, refCenterPosition) {
    ...
    RectangleRoi.prototype.getDistanceToRefObjectParllelToCenterOfGravityLine = function (refRoiToolAngle, refCenterPosition) {
    ...
    RectangleRoi.prototype.setSpacing = function (distanceA, index, equidistance, refRoiToolAngle) {
